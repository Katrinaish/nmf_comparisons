...
def generate_nmf_observed_vals(testCaseNum, totalFeat, fileDir, nmfCutOff, testing):
    """
    ...
    with open(fileDir + str(testCaseNum) + "/" + "featuresProb_testCase" + str(testCaseNum) + "_k_3.csv") as nmfFile:
...
def generate_asaph_observed_vals(testCaseNum, totalFeat, fileDir, pc_comp_file, asaphCutOff, testing): 
    ...
    with open(fileDir + str(testCaseNum) + "/analysis/" + pc_comp_file) as asaph_one:
...
exp_one = generate_exp_results(testCaseFileName, 1, 300)
exp_two = generate_exp_results(testCaseFileName, 2, 300)
exp_three = generate_exp_results(testCaseFileName, 3, 300)
exp_four = generate_exp_results(testCaseFileName, 4, 300)
...
testCase_one_nmf_obs = generate_nmf_observed_vals(1, 300, "/data1/compbio/kschlum/ecoli/asaph_out/test_case_" , 0.7, "present")
testCase_two_nmf_obs = generate_nmf_observed_vals(2, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_" , 0.7, "present")
testCase_three_nmf_obs = generate_nmf_observed_vals(3, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_" , 0.7, "present")
testCase_four_nmf_obs = generate_nmf_observed_vals(4, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_" , 0.7, "absent")
testCase_five_nmf_obs = generate_nmf_observed_vals(5, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_" , 0.7, "absent")
testCase_six_nmf_obs = generate_nmf_observed_vals(6, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_" , 0.7, "absent")


#get asaph observed values
testCase_one_asaph_obs = generate_asaph_observed_vals(1, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_", "snp_pc_1_logreg_assoc_tests.tsv", 0.001, "present")
testCase_two_asaph_obs = generate_asaph_observed_vals(2, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_", "snp_pc_1_logreg_assoc_tests.tsv", 0.001, "present")
testCase_three_asaph_obs = generate_asaph_observed_vals(3, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_", "snp_pc_1_logreg_assoc_tests.tsv", 0.001 ,"present")
testCase_four_asaph_obs = generate_asaph_observed_vals(4, 300,"/data1/compbio/kschlum/ecoli/asaph_out/test_case_", "snp_pc_1_logreg_assoc_tests.tsv", 0.001, "absent")
